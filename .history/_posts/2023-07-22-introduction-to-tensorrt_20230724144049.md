...
- Download and install NVIDIA CUDA 10.0 or later following the official instructions: [link](https://developer.nvidia.com/cuda-toolkit-archive)

- Download and extract CuDNN library for your CUDA version from: [link](https://developer.nvidia.com/cudnn)

- Download and extract NVIDIA TensorRT library for your CUDA version from: [link](https://developer.nvidia.com/nvidia-tensorrt-6x-download). Minimum required version is 6.0.1.5. Follow the Installation Guide for your system and ensure Python's part is installed.
