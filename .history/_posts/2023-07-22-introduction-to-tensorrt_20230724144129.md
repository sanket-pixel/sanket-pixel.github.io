...
- Download and extract NVIDIA TensorRT library for your CUDA version from: [link](https://developer.nvidia.com/nvidia-tensorrt-8x-download). Minimum required version is 6.0.1.5. Follow the Installation Guide for your system and ensure Python's part is installed.
