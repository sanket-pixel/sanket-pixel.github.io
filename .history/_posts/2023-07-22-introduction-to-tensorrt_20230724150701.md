...
The Mean Absolute Error between torch ouput and tensorrtis tending towards zero which indicates that even the post quantization results are similar ( if not equal ) to the pure pytorch output. 
