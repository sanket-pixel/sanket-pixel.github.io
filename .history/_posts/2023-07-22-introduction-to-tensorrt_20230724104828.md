...
<div class="row">
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.html path="/assets/img/blog/blog_1/latency_compare.png" title="have you met" class="img-fluid rounded z-depth-1" %}
    </div>
</div>
<div class="caption">
    Latency comparision between Pure Torch and TensorRT inference.
</div>
